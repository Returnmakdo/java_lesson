...
public class MyClass1Test {
	public static void main(String[] args) {
		...
		// 패키지가 다른 MyClass1 클래스의 필드 중 사용할 수 있는것은? : point
		//                             default 한정자 필드 name, 메소드 get,set age는 사용못함
//		my.name = "momo";
		my.point = 1.234;
...
//		System.out.println("name = " + my.name);   
		...
		//Score 클래스필드, 메소드의 한정자가 default 입니다.
		//   new 객체생성은 될까? class는 public한정자이므로 생성된다.
